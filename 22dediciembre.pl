...
%america es continente de peru
continente(america,peru).
continente(america,argentina).
continente(america,mexico).
continente(america,eeuu).
continente(europa,italia).
continente(europa,españa).
continente(europa,francia).
continente(europa,inglaterra).
continente(asia,china).
continente(asia,japon).
continente(asia,corea).
continente(asia,india).

%español es idioma de peru
idioma(español,peru).
...
idioma(frances,francia).
idioma(ingles,inglaterra).
idioma(chino,china).
idioma(japones,japon).
idioma(coreano,corea).
idioma(hindi,india).


%peru es pais de origen de juan.
paisdeorigen(peru,juan).
paisdeorigen(argentina,mario).
paisdeorigen(italia,ruben).
paisdeorigen(china,teodoro).
paisdeorigen(argentina,victor).
paisdeorigen(italia,alejandro).
paisdeorigen(corea,juanito).
paisdeorigen(china,julio).
paisdeorigen(mexico,jorge).
paisdeorigen(eeuu,paulino).
paisdeorigen(francia,leonardo).
paisdeorigen(corea,ernesto).
paisdeorigen(corea,paul).
paisdeorigen(mexico,antony).
...
paisdeorigen(gloria).
paisdeorigen(marina1).
paisdeorigen(alicia).
paisdeorigen(brigida).
paisdeorigen(marina2).
paisdeorigen(amelia).
paisdeorigen(irma).
paisdeorigen(tiburcia).
paisdeorigen(graciela).
paisdeorigen(griselda).
paisdeorigen(marilyn).
paisdeorigen(jessica).
paisdeorigen(veronica).
paisdeorigen(rosa).
ppaisdeorigen(jeny).
paisdeorigen(beatriz).
paisdeorigen(ashly).
paisdeorigen(ariana).
